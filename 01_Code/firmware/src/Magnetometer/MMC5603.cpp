// // Original Magnetometer code (.ino)
// #include <Arduino.h> // Added for .cpp compatibility
// #include <Wire.h>
...
//   // Normalize scaling for Soft-iron calibration
//   float avg_range = ((mag_max[0] - mag_min[0]) +
//                      (mag_max[1] - mag_min[1]) +
//                      (mag_max[2] - mag_min[2])) / 6.0;
